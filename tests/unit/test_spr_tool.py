...
def _view(*, pot: int = 1_000, my_stack: int = 9_000, effective_stack: int = 9_000) -> PlayerView:
    return PlayerView(
        my_seat=3,
        my_hole_cards=("As", "Kd"),
        community=(),
        ...
        hand_history=(),
        legal_actions=LegalActionSet(tools=(ActionToolSpec(name="check", args={}),)),
        opponent_stats={},
        hand_id=1,
        street=Street.FLOP,
        button_seat=0,
